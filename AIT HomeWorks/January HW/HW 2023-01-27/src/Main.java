...
public class Main {
    public static void main(String[] args) {
        String text = "Посадил дед репку. Выросла репка большая-пребольшая. Пошёл дед репку рвать: тянет-потянет, вытянуть не может! " +
        ...
        String text3 = """
                ...
                И сердца горестных замет.«Мой дядя самых честных правил,
                ...
                Кривые толки, шум и брань!Деревня, где скучал Евгений,
        ...
        System.out.println(mostFrequentlyWordsInText(text, 10));
        System.out.println(mostFrequentlyWordsInText(text3, 50));
    }

    public static List<Map.Entry<String, Integer>> mostFrequentlyWordsInText(String str, int count) {
        if (str == null) {
            System.out.println("Некорректная строка");
            return null;
        }
        List<Map.Entry<String, Integer>> listOfCountedWords = getListOfCountedWords(str);
        if (listOfCountedWords.size() < count) {
            System.out.println("В тексте нет такого количества уникальных слов");
            return null;
        }
        List<Map.Entry<String, Integer>> resultList = new ArrayList<>();
        for (int i = 0; i < count; i++) {
            resultList.add(listOfCountedWords.get(i));
        }
        return resultList;
    }

    public static List<Map.Entry<String, Integer>> getListOfCountedWords (String str) {
        HashMap<String, Integer> hashMap = splitTextToWords(str);
        List<Map.Entry<String, Integer>> entries = new ArrayList<>(hashMap.entrySet());
        entries.sort(Map.Entry.comparingByValue(Comparator.reverseOrder()));
        return entries;
    }

    public static HashMap<String, Integer> splitTextToWords(String str) {
