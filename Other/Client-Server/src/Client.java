...
public class Client {
    ...
    public static void main(String[] args) {
        // адрес - локальный хост, порт - 1111, такой же как у сервера
        try {
            try {
                clientSocket = new Socket("localhost", 4004); // так мы запрашиваем у сервера доступ на соединение
                ...
                // если соединение произошло и потоки успешно созданы - мы можем работать дальше и предложить клиенту что-то ввести
